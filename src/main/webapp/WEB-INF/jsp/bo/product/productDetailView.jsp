										...
										<tr>
											<td>
												<div>
													...
													<input type="hidden" name="changeNames" value="${ list[0].changerName }"> 
												</div>
												<div>메인이미지</div>
											</td>
											<td>
												<div>
													...
													<input type="hidden" name="changeNames" value="${ list[1].changerName }"> 
												</div>
												<div>2번</div>
											</td>
											<td>
												<div>
													...
													<input type="hidden" name="changeNames" value="${ list[2].changerName }"> 
												</div>
												<div>3번</div>
											</td>
											<td>
												<div>
													...
													<input type="hidden" name="changeNames" value="${ list[3].changerName }"> 
												</div>
												<div>4번</div>
											</td>
										</tr>
										<tr>
											<td>
												<div>
													...
													<input type="hidden" name="changeNames" value="${ list[4].changerName }"> 
												</div>
												<div>5번</div>
											</td>
											<td>
												<div>
													...
													<input type="hidden" name="changeNames" value="${ list[5].changerName }"> 
												</div>
												<div>6번</div>
											</td>
											<td>
												<div>
													...
													<input type="hidden" name="changeNames" value="${ list[6].changerName }"> 
												</div>
												<div>7번</div>
											</td>
											<td>
												<div>
													...
													<input type="hidden" name="changeNames" value="${ list[7].changerName }"> 
												</div>
												<div>8번</div>
											</td>
										</tr>
										<tr>
											<td>
												<div>
													...
													<input type="hidden" name="changeNames" value="${ list[8].changerName }"> 
												</div>
												<div>9번</div>
											</td>
											<td>
												<div>
													...
													<input type="hidden" name="changeNames" value="${ list[9].changerName }"> 
												</div>
												<div>10번</div>
											</td>
										</tr>
